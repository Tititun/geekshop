# Generated by Django 3.2.9 on 2021-12-23 09:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено в работу'), ('PD', 'оплачено'), ('PRD', 'обрабатывается'), ('RDY', 'готов'), ('CNC', 'отмена')], default='FM', max_length=3, verbose_name='статус')),
